...
def compress_all_images(src_folder, dest_org_folder, dest_folder, max_size_kb):
    """ 壓縮來源資料夾中的所有圖片，直到每張圖片大小小於 max_size_kb """
    image_paths = get_all_images(dest_org_folder)
    compressed_images = []
...
def main():
    ...
    # 壓縮圖片
    compressed_files = compress_all_images(src_folder, dest_org_folder, dest_folder, max_size_kb)
